...
HUMAN_BAR_KEEPER_OFFSET_X = MARGIN_LEFT + BAR_POSITION_KEEPER_HUMAN - BAR_WIDTH / 2
HUMAN_BAR_KEEPER_OFFSET_Y = MARGIN_TOP

HUMAN_BAR_DEFENDER_OFFSET_X = MARGIN_LEFT + BAR_POSITION_DEFENDER_HUMAN - BAR_WIDTH / 2
HUMAN_BAR_DEFENDER_OFFSET_Y = MARGIN_TOP

HUMAN_BAR_MIDFIELDER_OFFSET_X = MARGIN_LEFT + BAR_POSITION_MIDFIELDER_HUMAN - BAR_WIDTH / 2
HUMAN_BAR_MIDFIELDER_OFFSET_Y = MARGIN_TOP

HUMAN_BAR_FORWARD_OFFSET_X = MARGIN_LEFT + BAR_POSITION_FORWARD_HUMAN - BAR_WIDTH / 2
HUMAN_BAR_FORWARD_OFFSET_Y = MARGIN_TOP

"""Spielstangen des Computers"""
COMPUTER_BAR_KEEPER_OFFSET_X = SCREEN_WIDTH - MARGIN_RIGHT - BAR_POSITION_KEEPER_COMPUTER - BAR_WIDTH / 2
COMPUTER_BAR_KEEPER_OFFSET_Y = MARGIN_TOP

COMPUTER_BAR_DEFENDER_OFFSET_X = SCREEN_WIDTH - MARGIN_RIGHT - BAR_POSITION_DEFENDER_COMPUTER - BAR_WIDTH / 2
COMPUTER_BAR_DEFENDER_OFFSET_Y = MARGIN_TOP

COMPUTER_BAR_MIDFIELDER_OFFSET_X = SCREEN_WIDTH - MARGIN_RIGHT - BAR_POSITION_MIDFIELDER_COMPUTER - BAR_WIDTH / 2
COMPUTER_BAR_MIDFIELDER_OFFSET_Y = MARGIN_TOP

COMPUTER_BAR_FORWARD_OFFSET_X = SCREEN_WIDTH - MARGIN_RIGHT - BAR_POSITION_FORWARD_COMPUTER - BAR_WIDTH / 2
COMPUTER_BAR_FORWARD_OFFSET_Y = MARGIN_TOP


"""Offset Positionen zum zeichnen der Figuren im Screen"""
HUMAN_KEEPER_OFFSET_X = MARGIN_LEFT + BAR_POSITION_KEEPER_HUMAN
HUMAN_KEEPER_OFFSET_Y = (COURT_HEIGHT - MAX_POS_KEEPER) / 2 + MARGIN_TOP

HUMAN_DEFENDER_OFFSET_X = MARGIN_LEFT + BAR_POSITION_DEFENDER_HUMAN
HUMAN_DEFENDER_OFFSET_Y = (COURT_HEIGHT - MAX_POS_DEFENDER - DEFENDER_DISTANCE_BETWEEN_FIGURES) / 2 + MARGIN_TOP

HUMAN_MIDFIELDER_OFFSET_X = MARGIN_LEFT + BAR_POSITION_MIDFIELDER_HUMAN
HUMAN_MIDFIELDER_OFFSET_Y = HUMAN_DEFENDER_OFFSET_Y

HUMAN_FORWARD_OFFSET_X = MARGIN_LEFT + BAR_POSITION_FORWARD_HUMAN
HUMAN_FORWARD_OFFSET_Y = HUMAN_DEFENDER_OFFSET_Y

COMPUTER_KEEPER_OFFSET_X = SCREEN_WIDTH - MARGIN_RIGHT - BAR_POSITION_KEEPER_COMPUTER
COMPUTER_KEEPER_OFFSET_Y = HUMAN_KEEPER_OFFSET_Y

COMPUTER_DEFENDER_OFFSET_X = SCREEN_WIDTH - MARGIN_RIGHT - BAR_POSITION_DEFENDER_COMPUTER
COMPUTER_DEFENDER_OFFSET_Y = HUMAN_DEFENDER_OFFSET_Y

COMPUTER_MIDFIELDER_OFFSET_X = SCREEN_WIDTH - MARGIN_RIGHT - BAR_POSITION_MIDFIELDER_COMPUTER
COMPUTER_MIDFIELDER_OFFSET_Y = HUMAN_DEFENDER_OFFSET_Y

COMPUTER_FORWARD_OFFSET_X = SCREEN_WIDTH - MARGIN_RIGHT - BAR_POSITION_FORWARD_COMPUTER
